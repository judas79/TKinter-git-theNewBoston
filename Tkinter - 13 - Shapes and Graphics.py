...
greenSphere = canvas1.create_oval(90, 40, 110, 60, width=4, fill='green') # x/y top left x/y bottom right, tkinter uses fill to designate color and width for the thickness
